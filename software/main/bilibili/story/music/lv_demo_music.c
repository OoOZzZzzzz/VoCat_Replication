...
void vocat_lv_demo_music_with_args(const vocat_lv_demo_args_t * args)
{
    ...
    list = vocat_lv_demo_music_list_create(root);
    ctrl = vocat_lv_demo_music_main_create(root);
