...
# endif
    ...
    LV_IMAGE_DECLARE(vocat_music_logo);
    lv_obj_t * logo = lv_image_create(parent);
    lv_image_set_src(logo, &vocat_music_logo);
...
void vocat_lv_demo_music_resume(void)
{
    ...
    lv_slider_set_range(slider_obj, 0, vocat_lv_demo_music_get_track_length(track_id));
...
static void create_wave_images(lv_obj_t * parent)
{
    ...
    LV_IMAGE_DECLARE(vocat_music_corner_left);
    LV_IMAGE_DECLARE(vocat_music_corner_right);
    lv_obj_t * wave_corner = lv_image_create(parent);
    lv_image_set_src(wave_corner, &vocat_music_corner_left);
    ...
    lv_image_set_src(wave_corner, &vocat_music_corner_right);
#if LV_DEMO_MUSIC_ROUND == 0
...
static lv_obj_t * create_icon_box(lv_obj_t * parent)
{
    ...
    lv_obj_t * icon;
    LV_IMAGE_DECLARE(vocat_music_icon_1);
    LV_IMAGE_DECLARE(vocat_music_icon_2);
    LV_IMAGE_DECLARE(vocat_music_icon_3);
    LV_IMAGE_DECLARE(vocat_music_icon_4);
    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_icon_1);
    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_icon_2);
    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_icon_3);
    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_icon_4);
...
static lv_obj_t * create_ctrl_box(lv_obj_t * parent)
{
    ...
    LV_IMAGE_DECLARE(vocat_music_btn_loop);
    LV_IMAGE_DECLARE(vocat_music_btn_rnd);
    ...
    lv_obj_t * icon;
    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_btn_rnd);
    lv_obj_set_grid_cell(icon, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 0, 1);

    icon = lv_image_create(cont);
    lv_image_set_src(icon, &vocat_music_btn_loop);
    ...
    lv_obj_set_width(play_obj, vocat_music_btn_play.header.w);
...
static void track_load(uint32_t id)
{
    ...
    vocat_lv_demo_music_list_button_check(id, true);
...
static void album_gesture_event_cb(lv_event_t * e)
{
    ...
    if(dir == LV_DIR_RIGHT) vocat_lv_demo_music_album_next(false);
}
